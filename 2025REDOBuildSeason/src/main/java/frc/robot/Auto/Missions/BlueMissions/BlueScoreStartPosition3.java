 ...
 * zone to score a coral on L3 for face LK
 */

public class BlueScoreStartPosition3 extends MissionBase{
    ...
    protected void routine() throws AutoMissionEndedException {
       ...
       // runAction(new WaitAction(AutoMissionChooser.delay)); // MAY NOT BE NEEDED
        ...
        runAction(new TurnDegreesAction(-130, 1));// add 5 degrees because michalangelo has consistently com up 5 degrees short of the needed turn
